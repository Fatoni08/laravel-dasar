    ...
    <div class="container">
        ...
        <form action="{{ url($product->id. '/update') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="input2" name="description" value="{{ $product->description }}">
            </div>
            <div class="form-group">
                <label for="input3">Harga Produk</label>
                <input type="text" class="form-control" id="input3" name="price" value="{{ $product->price }}">
            </div>
